...
function iteratePitchingLoaders(options, loaderContext, callback) {
	...
	// load loader module 
	// 加载 loader 添加 normal 及 loader模块内容  pitch raw 属性
...
/* 
	...
	options 
	loaderContext
	args[Array] 如果是入口,入口文件的buffer [buffer]
*/
function iterateNormalLoaders(options, loaderContext, args, callback) {
	...
	// iterate
	// 如果已经执行过，递归执行下一个 （按照loader的顺序，从后往前执行）
